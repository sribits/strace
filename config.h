...
/* Define to 1 if you have the declaration of ` PTRACE_EVENT_CLONE', and to 0
   if you don't. */
#define HAVE_DECL_____PTRACE_EVENT_CLONE 1

/* Define to 1 if you have the declaration of ` PTRACE_EVENT_FORK', and to 0
   if you don't. */
#define HAVE_DECL_____PTRACE_EVENT_FORK 1

/* Define to 1 if you have the declaration of ` PTRACE_EVENT_VFORK', and to 0
   if you don't. */
#define HAVE_DECL_____PTRACE_EVENT_VFORK 1

/* Define to 1 if you have the declaration of ` PTRACE_GETEVENTMSG', and to 0
   if you don't. */
#define HAVE_DECL_____PTRACE_GETEVENTMSG 1

/* Define to 1 if you have the declaration of ` PTRACE_GETSIGINFO', and to 0
   if you don't. */
#define HAVE_DECL_____PTRACE_GETSIGINFO 1

/* Define to 1 if you have the declaration of ` PTRACE_O_TRACECLONE', and to 0
   if you don't. */
#define HAVE_DECL_____PTRACE_O_TRACECLONE 1

/* Define to 1 if you have the declaration of ` PTRACE_O_TRACEFORK', and to 0
   if you don't. */
#define HAVE_DECL_____PTRACE_O_TRACEFORK 1

/* Define to 1 if you have the declaration of ` PTRACE_O_TRACEVFORK', and to 0
   if you don't. */
#define HAVE_DECL_____PTRACE_O_TRACEVFORK 1

/* Define to 1 if you have the declaration of ` PTRACE_SETOPTIONS', and to 0
   if you don't. */
#define HAVE_DECL_____PTRACE_SETOPTIONS 1
...
#define PACKAGE_STRING "strace 4.6"
